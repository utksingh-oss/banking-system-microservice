...
@Tag(
        ...
        description = "REST APIs for creating, read, update and delete operations for customer accounts"
)
@RestController
...
public class AccountsController {
    ...
    @Operation(
            ...
            description = "REST API to fetch the build info about the API endpoints"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
